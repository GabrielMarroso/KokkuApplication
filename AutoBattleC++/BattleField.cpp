...
void BattleField::StartGame()
{
    ...
    EnemyCharacter->target = PlayerCharacter->get();
    PlayerCharacter->target = EnemyCharacter->get();
   // AllPlayers->push_back(PlayerCharacter); batata
