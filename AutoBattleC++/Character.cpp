...
void Character::StartTurn(Grid* battlefield) {

    {
        ...
        {   // if there is no target close enough, calculates in wich direction this character should move to be closer to a possible target
            ...
            if (currentBox.xIndex > target->get()->currentBox.xIndex) 
                //target->currentBox.xIndex)
            {
            ...
            else if (currentBox.xIndex < target->get()->currentBox.xIndex)
            {
                currentBox.ocupied = false;
                battlefield->grids[currentBox.Index] = currentBox;
                currentBox = (battlefield->grids[currentBox.Index + 1]);
            ...
            if (currentBox.yIndex > target->get()->currentBox.yIndex)
            {
                battlefield->drawBattlefield(5, 5);
                currentBox.ocupied = false;
                battlefield->grids[currentBox.Index] = currentBox;
            ...
            else if (currentBox.yIndex < target->get()->currentBox.yIndex)
            {
                currentBox.ocupied = true;
                battlefield->grids[currentBox.Index] = currentBox;
                currentBox = battlefield->grids[currentBox.Index + battlefield->xLenght];
